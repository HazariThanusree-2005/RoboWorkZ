...
// Robotics Rentals card data
const cardData = [
  {
    color: '#0e0e11',
    title: 'Flexible Plans',
    description: 'Daily, weekly, or event-based rental options customized to your specific requirements.',
    label: 'Rental'
  },
  {
    color: '#0e0e11',
    title: 'Turnkey Delivery',
    description: 'Complete logistics, on-site installation, precision calibration, and deployment support.',
    label: 'Logistics'
  },
  {
    color: '#0e0e11',
    title: '24/7 Expert Backup',
    description: 'End-to-end operational support and highly-trained on-site engineering backup. We guarantee maximum uptime for your critical events.',
    label: 'Support'
  },
  {
    color: '#0e0e11',
    title: 'Event-Ready Robots',
    description: 'Pre-configured robots optimized for exhibitions, product launches, and corporate events.',
    label: 'Events'
  },
  {
    color: '#0e0e11',
    title: 'Real-Time Control',
    description: 'Live monitoring dashboard with remote diagnostics and instant override capabilities.',
    label: 'Control'
  },
  {
    color: '#0e0e11',
    title: 'Custom Branding',
    description: 'Personalize robot appearance and behavior to match your brand identity and event theme.',
    label: 'Brand'
  }
];
    ...
    <>
      ...
      <div className="card-grid bento-section" ref={gridRef}>
        {cardData.map((card, index) => {
          ...
          const cardStyle = { backgroundColor: card.color, '--glow-color': glowColor };
